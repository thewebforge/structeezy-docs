...
Structeezy 1.2 and brigs awesome new features to help you save plenty of time when creating your structures.
...
Structeezy now integrates directly with the [Iconify](https://iconify.design/) API to allow searching and inserting icons in you page structures from a the iconify huge list of icon sets.
