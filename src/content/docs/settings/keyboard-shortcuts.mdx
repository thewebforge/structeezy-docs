...
:::tip
As a developer, I use a Chrome extension called Hoverify to inspect the DOM. It uses the `alt + s` shortcut to open its panel. So I changed my Structeezy shortcut to `e + z` to avoid conflicts. It is very well positionned on my french keyboard, and I find it easier to remember too.  
