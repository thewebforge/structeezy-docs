...
description: Let’s learn how to generate Bricks elements from html by creating Airbnbricks with Structeezy.
sidebar:
  order: 1
  label: Airbnbricks
head:
- tag: meta
  attrs:
    property: og:image
    content: https://docs.structeezy.com/open-graph/tutorials/airbnbricks.png
- tag: meta
  attrs:
...
If you don’t have a Structeezy license yet, you can follow this tutorial inserting all elements manually in Bricks, or you can [purchase one here](https://structeezy.com/).
