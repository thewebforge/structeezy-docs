...
description: This page lists common questions about using the Structeezy with your favorite CSS Framework.
sidebar:
  label: Delete plugin
head:
  - tag: meta
    attrs:
      property: og:image
      content: https://docs.structeezy.com/open-graph/css-frameworks.png
  - tag: meta
    attrs:
...
**CSS to map Structeezy localy scoped varaiables to your framework**
