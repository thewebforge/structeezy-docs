...
class LiteYTEmbed extends HTMLElement {
    videoId: string | null = "";
    playLabel: string = "";
    needsYTApiForAutoplay: boolean = false;
    static preconnected: any;
    ytApiPromise: Promise<unknown> | undefined;
    connectedCallback() {
        this.videoId = this.getAttribute('videoid');

        let playBtnEl = this.querySelector('.lty-playbtn') as HTMLButtonElement | null;
