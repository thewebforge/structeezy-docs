...
You can also make a huge contribution by getting involved by leaving review comments on [PRs](https://github.com/thewebforge/structeezy-docs/pulls), adding ideas in existing GitHub [Issues](https://github.com/thewebforge/structeezy-docs/issues) and [Discussions](https://github.com/thewebforge/structeezy-docs/discussions)! 
...
- **Look at our Existing Issues** (especially those labelled [`help wanted`](https://github.com/thewebforge/structeezy-docs/issues?q=is:open+is:issue+label:%22help+wanted%22) and [`good first issue`](https://github.com/thewebforge/structeezy-docs/issues?q=is:open+is:issue+label:%22good+first+issue%22)) for contributions we are actively seeking.
...
If you're unsure which type of contribution best represents your concern, please [make a new issue](https://github.com/thewebforge/structeezy-docs/issues/new)!
...
Every page on [docs.structeezy.com](https://docs.structeezy.com/) has an **Edit this page** button in the sidebar. You can click that button to edit the source code for that page in **GitHub**.
...
- [Fork the docs](https://github.com/thewebforge/structeezy-docs/fork)
- [Raise an issue](https://github.com/thewebforge/structeezy-docs/issues/new)
- [Discuss the docs](https://github.com/thewebforge/structeezy-docs/discussions)
